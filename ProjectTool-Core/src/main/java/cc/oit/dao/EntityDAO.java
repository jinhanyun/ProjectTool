...
public interface EntityDAO<T extends Entity> {
    ...
    @ResultMap("getMap")
    public List<T> query(@Param("queryParams") List<CustomQueryParam> customQueryParams, @Param("sortList") List<sun.misc.Sort> sortList,  @Param("start") Integer start,  @Param("limit") Integer limit);
